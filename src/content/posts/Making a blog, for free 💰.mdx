...
So, as you can tell, I made a blog (woo hoo 🎉). The reasons for "why" can can be seen in my[ first post](./why). (Spoiler: Unemployment, probably). But hey, perhaps you too are wondering how to create a blog not only quickly, but also cheaply, and have it look pretty decent too.
<br/>
